...
> This library makes it easy to support Seq from Node.js logging libraries, initially `node-bunyan`. It is not expected that applications will interact directly with this package.
